...
const CONTACT_EMAIL = "sandhyatimilsena42@gmail.com"; // Replace with your email address
const WHATSAPP_NUMBER = "9825711653"; // +977 Nepal
          ...
          <div className="contact-info">
            ...
            <div className="contact-details">
              <div className="contact-item">
                ...
                <a href="mailto:sandhyatimilsena42@gmail.com">
                  sandhyatimilsena42@gmail.com
                </a>
              </div>
              <div className="contact-item">
          ...
          <div className="contact-form">
            ...
            <form onSubmit={(e) => e.preventDefault()} noValidate>
              ...
              >
                ...
                >
                  <i className="fab fa-whatsapp" aria-hidden="true"></i> Send
                  via WhatsApp
                </button>
                <button
                  type="button"
                ...
                >
                  <i className="fas fa-envelope" aria-hidden="true"></i> Send
                  via Email
                </button>
              </div>
            </form>
